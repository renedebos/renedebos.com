...
def build_history():
  ...
  <section class="about">
    ...
    <ul class="reasons">
      ...
      <li>Settled on <strong>one loudness standard for the entire archive</strong> &mdash; after A/B testing confirmed the full-band shows gained nothing audible from being louder, the Mad Hannans sets now sit at the same comfortable level as everything else. First through the new process: the <strong>Mad Hannans at Sweetwater</strong> (Feb&nbsp;17,&nbsp;2000) and the Oct&nbsp;17,&nbsp;2000 <strong>Birthday Show</strong>.</li>
