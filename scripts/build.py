...
def build_history():
  ...
  <section class="about">
    ...
    <p>
      The cleanup work grew up into a proper, repeatable process. Instead of treating each show by hand, there&rsquo;s now an <strong>automated audio-engineering workflow</strong> that takes the original lossless masters and brings every track to a consistent, comfortable listening level &mdash; solo sets kept a little more dynamic and breathing, the full-band shows a touch denser &mdash; all with a ceiling that prevents digital clipping.
    </p>
    <ul class="reasons">
